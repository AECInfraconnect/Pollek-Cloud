...
function createLocalEntityState() {
  // Real user/entity/relationship state is populated only through the gated
  // ingest paths (entity ingest, registry sync, telemetry). No fabricated fleet.
  return { users: [], entities: [], relationships: [], syncRuns: [] };
}

...
const PATH_METHODS = {
  ...
  "/contracts/bundle-provenance.schema.json": ["get"],
  "/contracts/trust-policy.schema.json": ["get"],
  "/contracts/revocation-list.schema.json": ["get"],
  "/contracts/signer-allowlist.schema.json": ["get"],
  "/api/events": ["get"],
  ...
  "/v1/tenants/{tenant_id}/telemetry/decision-logs": ["get"],
  "/v1/tenants/{tenant_id}/telemetry/export": ["get"],
  "/v1/tenants/{tenant_id}/logs/decisions": ["get"],
  "/v1/tenants/{tenant_id}/logs/tool-invocations": ["get"],
  "/v1/tenants/{tenant_id}/logs/resource-access": ["get"],
  "/v1/tenants/{tenant_id}/logs/policy-deployments": ["get"],
  "/v1/tenants/{tenant_id}/logs/pep-health": ["get"],
  "/api/telemetry/ingest-status": ["get"],
  ...
  "/api/reports/cost-tokens": ["get"],
  "/api/reports/cost-tokens/overview": ["get"],
  "/v1/tenants/{tenant_id}/reports/cost-tokens": ["get"],
  "/v1/tenants/{tenant_id}/reports/cost-tokens/overview": ["get"],
  "/api/entities": ["get"],
